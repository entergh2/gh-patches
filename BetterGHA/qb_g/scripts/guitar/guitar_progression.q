...
GH3_Career_Songs = {
	...
	tier1 = {
		title = "1. Bring die Band zusammen"
		songs = [
			dreampolice
			alltheyoungdudes
			makeit
	...
	tier2 = {
		title = "2. Erster Geschmack des Erfolgs"
		songs = [
	...
	tier3 = {
		title = "3. Die triumphale Rückkehr"
		songs = [
			completecontrol
			personalitycrisis
			livinontheedge
	...
	tier4 = {
		title = "4. Internationale Superstars"
		songs = [
			shesellssanctuary
			kingofrock
			nobodysfault
	...
	tier5 = {
		title = "5. Die große amerikanische Band"
		songs = [
			hardtohandle
			alwaysontherun
			backinthesaddle
