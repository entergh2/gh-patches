...
script create_options_menu 
	...
	if IsWinPort
		displayText parent = om_container text = "OPTIONEN" pos = (750.0, 110.0) scale = 1.6 just = [center center] rgba = [0 0 20 255] font = text_A11_large z = 10 rot = <rot> noshadow
		displayText parent = om_container text = "OPTIONEN" pos = (745.0, 115.0) scale = 1.6 just = [center center] rgba = [191 237 226 255] font = text_A11_large z = 9 rot = <rot> noshadow
	else
		displayText parent = om_container text = "OPTIONEN" pos = (700.0, 105.0) scale = 1.9 just = [center center] rgba = [0 0 20 255] font = text_A11_large z = 10 rot = <rot> noshadow
		displayText parent = om_container text = "OPTIONEN" pos = (695.0, 110.0) scale = 1.9 just = [center center] rgba = [191 237 226 255] font = text_A11_large z = 9 rot = <rot> noshadow
	endif
	CreateScreenElement {
		type = SpriteElement
		parent = om_container
