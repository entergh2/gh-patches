...
options_calibrate_lag_dialog_1_fs = {
	...
	create_params = {
		...
		body_text = "Zuerst versuchen wir mal eine Audio-Kalibrierung. Schlage einfach im Rhythmus der Klicks an. Versuche den Anschlagschalter genau dann zu betätigen, wenn du den Klick hörst."
		dialog_1
	}
...
options_calibrate_lag_dialog_2_fs = {
	...
	create_params = {
		...
		body_text = "Als nächstes versuchen wir einen Video-Kalibrierungstest. Versuche den Anschlagschalter zu betätigen, wenn sich die Kreise genau über dem Ziel befinden."
		dialog_2
	}
	destroy = destroy_calibrate_lag_dialog_menu
	actions = [
