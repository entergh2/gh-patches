...
battle_explanation_text = {
	bossjoe = {
		...
		title = "JOE PERRY WILL EINE GITARRENSCHLACHT!"
		bullets = [
			{
				text = "Triff jede Serie von BATTLESYMBOLEN, um ANGRIFFE zu sammeln."
			}
			{
				text = "Sobald du einen ANGRIFF erhalten hast, ziehst du deine Gitarre nach oben, um Joe zu stören und einen Fehlschlag zu provozieren."
			}
			{
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Sobald du einen ANGRIFF erhalten hast, ziehst du deine Gitarre nach oben, um deinen Gegner zu stören und einen Fehlschlag zu provozieren."
			}
			{
