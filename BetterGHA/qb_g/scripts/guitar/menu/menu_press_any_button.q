...
script create_attract_mode_text 
	CreateScreenElement \{type = ContainerElement
		...
		id = am_container
		pos = (0.0, 0.0)}
	text = "DRÜCKE EINE BELIEBIGE TASTE ZUM SPIELEN ..."
...
script check_for_any_input \{button1 = {
	...
	if NOT IsWinPort
		if IsStandardGuitarControllerPluggedIn
			if English
				notify_box scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "Ein nicht unterstütztes Peripheriegerät wurde gefunden." line2 = "Schließen Sie entweder eine Guitar Hero-Gitarre oder einen" line3 = "Xbox 360 Controller an und drücken Sie START, um fortzufahren." menu_z = 510000 FormatText TextName = pakname '%s_text.pak' s = <stem>
			elseif French
				notify_box \{scale1 = (0.6, 0.75)
					scale2 = (0.5, 0.6)
