...
script create_lefty_flip_warning_menu 
	...
	create_popup_warning_menu {
		textblock = {
			text = "Song neu starten, um die Linkshändereinstellung zu ändern.  Bei einem Neustart gehen alle nichtgespeicherten Fortschritte verloren. Wollen Sie wirklich fortfahren?"
			dims = (800.0, 400.0)
			scale = 0.55
		}
