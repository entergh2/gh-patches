...
string_ps2_PRESS_ANY_BUTTON_TO_ROCK = "PRESS ANY BUTTON TO ROCK..."
string_ps2_JUST_PRESS_ANY_BUTTON = "JUST PRESS ANY BUTTON TO PLAY..."
...
script get_string_ps2 \{message = unknown}
	...
	switch <message>
		...
		if (<use_localized> = true)
			localized_string = "Status of the ^Memory Card (8MB) (for PlayStation®2)^ in ^MEMORY CARD slot 1^ has changed. If you wish to continue with the current ^Memory Card (8MB) (for PlayStation®2)^ all previous profile saves will be overwritten. Do you wish to overwrite previous game save data?"
		else
...
string_ps2_fowlvis_outfit_style_5 = "Transylvania"
...
string_ps2_loading_screen_tip_02 = "Check out The Vault for new songs and cool outfits and styles."
