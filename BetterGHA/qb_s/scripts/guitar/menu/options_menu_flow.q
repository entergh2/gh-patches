...
options_calibrate_lag_dialog_1_fs = {
	...
	create_params = {
		title_text = "PRUEBA DE AUDIO"
		body_text = "Para empezar, calibraremos solo el audio. Solo tienes que rasguear siguiendo el ritmo de los clics. Intenta que la barra de toque haga clic exactamente en el mismo instante que el clic del audio."
		dialog_1
	}
...
options_calibrate_lag_dialog_2_fs = {
	create = create_calibrate_lag_dialog_menu
	create_params = {
		title_text = "PRUEBA DE VÍDEO"
		body_text = "Ahora, calibraremos solo el vídeo. Intenta rasguear cuando los círculos estén perfectamente alineados con el objetivo."
		dialog_2
	}
	destroy = destroy_calibrate_lag_dialog_menu
	actions = [
