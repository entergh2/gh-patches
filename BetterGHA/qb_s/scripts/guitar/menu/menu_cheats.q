...
script create_cheats_menu 
	...
	if (<unlock_Cheat_NoFail> > 0)
		if ($Cheat_NoFail = 1)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [3].name_text)
		else
			if ($Cheat_NoFail < 0)
				change \{Cheat_NoFail = 2}
			endif
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [3].name_text)
		endif
	endif
	CreateScreenElement {
		<text_params2>
	...
	if (<unlock_Cheat_AirGuitar> > 0)
		if ($Cheat_AirGuitar = 1)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [0].name_text)
		else
			if ($Cheat_AirGuitar < 0)
				change \{Cheat_AirGuitar = 2}
			endif
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [0].name_text)
		endif
	endif
	CreateScreenElement {
		<text_params2>
	...
	if (<unlock_Cheat_Hyperspeed> > 0)
		if ($Cheat_Hyperspeed > 0)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [2].name_text)
			FormatText TextName = text "%c, %d" c = <text> d = ($Cheat_Hyperspeed)
		else
			if ($Cheat_Hyperspeed < 0)
				change \{Cheat_Hyperspeed = 0}
			endif
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [2].name_text)
		endif
	endif
	CreateScreenElement {
		<text_params2>
	...
	if (<unlock_Cheat_PerformanceMode> > 0)
		if ($Cheat_PerformanceMode = 1)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [1].name_text)
		else
			if ($Cheat_PerformanceMode < 0)
				change \{Cheat_PerformanceMode = 2}
			endif
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [1].name_text)
		endif
	endif
	CreateScreenElement {
		<text_params2>
	...
	if (<unlock_Cheat_PrecisionMode> > 0)
		if ($Cheat_PrecisionMode = 1)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [4].name_text)
		else
			if ($Cheat_PrecisionMode < 0)
				change \{Cheat_PrecisionMode = 2}
			endif
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [4].name_text)
		endif
	endif
	CreateScreenElement {
		<text_params2>
...
script toggle_hyperspeed 
	if ($<cheat> >= 0)
		if ($<cheat> = 5)
			...
			FormatText TextName = text "%c : desactivado" c = ($guitar_hero_cheats [<index>].name_text)
			SetScreenElementProps id = <id> text = <text>
			SoundEvent \{event = Generic_Menu_Back_SFX}
		else
			change globalname = <cheat> newvalue = ($<cheat> + 1)
			FormatText TextName = text "%c : activado" c = ($guitar_hero_cheats [<index>].name_text)
			FormatText TextName = text "%c, %d" c = <text> d = ($Cheat_Hyperspeed)
			SetScreenElementProps id = <id> text = <text>
