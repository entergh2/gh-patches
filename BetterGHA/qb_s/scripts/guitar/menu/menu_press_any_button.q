...
script check_for_any_input \{button1 = {
	...
	if NOT IsWinPort
		if IsStandardGuitarControllerPluggedIn
			if English
				notify_box scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "Se ha detectado una guitarra conectada como periférico no compatible." line2 = "Conecta una guitarra Guitar Hero o" line3 = "el mando Xbox 360 y pulsa START para continuar." menu_z = 510000 FormatText TextName = pakname '%s_text.pak' s = <stem>
			elseif French
				notify_box \{scale1 = (0.6, 0.75)
					scale2 = (0.5, 0.6)
