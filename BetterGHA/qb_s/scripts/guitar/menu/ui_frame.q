...
script create_UI_frame \{frame_dims = (300.0, 500.0)
	...
	if IsWinPort
		...
		if ((<width> != 1280) || (<Height> != 720))
			SetArrayElement \{ArrayName = fill_rgba
				index = 3
				newvalue = 230}
			offset_TL = (0.3, 0.3)
			offset_TR = (-0.3, 0.3)
	...
	if ((<frame_dims>.(1.0, 0.0)) > (<min_width>))
		...
		if IsWinPort
			<frame_corner_TL_fill> :DoMorph pos = (<width_tops> * (-1.0, 0.0) + <offset_TL>)
			<frame_corner_TR_fill> :DoMorph pos = (<width_tops> * (1.0, 0.0) + <offset_TR>)
			<frame_corner_BL_fill> :DoMorph pos = (<width_tops> * (-1.0, 0.0) + <offset_BL>)
			<frame_corner_BR_fill> :DoMorph pos = (<width_tops> * (1.0, 0.0) + <offset_BR>)
		else
			if IsPs3
	...
	if ((<frame_dims>.(0.0, 1.0)) > (<min_height>))
		...
		if IsWinPort
			<frame_corner_TL_fill> :DoMorph pos = (<height_side> * (0.0, -1.0) + (<X_TL> * (1.0, 0.0)) + <offset_TL>)
			<frame_corner_TR_fill> :DoMorph pos = (<height_side> * (0.0, -1.0) + (<X_TR> * (1.0, 0.0)) + <offset_TR>)
			<frame_corner_BL_fill> :DoMorph pos = (<height_side> * (0.0, 1.0) + (<X_BL> * (1.0, 0.0)) + <offset_BL>)
			<frame_corner_BR_fill> :DoMorph pos = (<height_side> * (0.0, 1.0) + (<X_BR> * (1.0, 0.0)) + <offset_BR>)
		else
			if IsPs3
	...
	elseif (((<frame_dims>.(0.0, 1.0)) <= (<min_height>)) && ((<frame_dims>.(1.0, 0.0)) > (<min_width>)))
		...
		X_BR = (<pos>.(1.0, 1.0))
		if IsWinPort
			<frame_corner_TL_fill> :DoMorph pos = (<X_TL> * (1.0, 0.0) + <offset_TL>)
			<frame_corner_TR_fill> :DoMorph pos = (<X_TR> * (1.0, 0.0) + <offset_TR>)
			<frame_corner_BL_fill> :DoMorph pos = (<X_BL> * (1.0, 0.0) + <offset_BL>)
			<frame_corner_BR_fill> :DoMorph pos = (<X_BR> * (1.0, 0.0) + <offset_BR>)
		else
			if IsPs3
