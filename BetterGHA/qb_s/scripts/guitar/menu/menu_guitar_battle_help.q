...
battle_explanation_text = {
	bossjoe = {
		...
		title = "¡JOE PERRY QUIERE GUERRA!"
		bullets = [
			{
				text = "Acierta las series de NOTAS GUERRERAS para conseguir ATAQUES"
			}
			{
				text = "Cuando consigas un ATAQUE, levanta tu guitarra para distraer a Joe y hacerle que pierda"
			}
			{
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Cuando consigas un ATAQUE, levanta tu guitarra para distraer a tu oponente y hacerle que pierda"
			}
			{
				text = "DEBES hacer PERDER a tu rival antes del final u os enfrentaréis en Muerte súbita."
			}
			{
				text = "En la MUERTE SÚBITA todos los ATAQUES se convierten en el fatídico VACIADO MORTAL"
			}
		]
		prompt = "¿Listo para rockanrolear?"
	}
