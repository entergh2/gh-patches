...
GH3_Career_Songs = {
	...
	tier2 = {
		title = "2. Primera cita con el éxito"
		songs = [
	...
	tier4 = {
		title = "4. Superestrellas mundiales"
		songs = [
			shesellssanctuary
			kingofrock
			nobodysfault
	...
	tier5 = {
		title = "5. El gran grupo estadounidense"
		songs = [
			hardtohandle
			alwaysontherun
			backinthesaddle
	...
	tier6 = {
		title = "6. Leyendas del Rock 'N' Roll"
		songs = [
			catscratchfever
			sextypething
			bossjoe
