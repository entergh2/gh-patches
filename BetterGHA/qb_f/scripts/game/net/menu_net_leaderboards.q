...
script create_leaderboard_menu3 
	...
	if NOT IsWinPort
		if isXenon
			add_user_control_helper \{text = "CARTE DU JOUEUR"
				button = start
				z = 100}
		endif
	endif
...
script new_leaderboard_menu 
	...
	if NOT ((<my_data> [0]) = "pas de classement")
		FormatText TextName = rank "Classement : %d" d = (<my_data> [0])
	else
		rank = (<my_data> [0])
	endif
	CreateScreenElement {
