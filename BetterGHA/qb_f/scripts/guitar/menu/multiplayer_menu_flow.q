	...
	actions = [
		{
			...
			flow_state_func = mp_where_to_go_from_hub
		}
		{
...
script mp_where_to_go_from_hub 
	if NOT ($game_mode = p2_quickplay)
		return \{flow_state = mp_faceoff_select_venue_fs}
	else
		return \{flow_state = coop_quickplay_select_difficulty_fs}
	endif
endscript
