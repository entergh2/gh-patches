...
script add_basic_stats_desc 
	...
	add_text_to_column column = <desc_column> text = "RÉUSSITE" dims = (400.0, 0.0)
	if NOT ($game_mode = p2_battle || $current_song = bossjoe)
		add_text_to_column column = <desc_column> text = "SÉQUENCES SP" dims = (400.0, 0.0)
		if NOT ($game_mode = p2_coop || $game_mode = p2_quickplay)
