...
battle_explanation_text = {
	bossjoe = {
		...
		title = "JOE PERRY VEUT T'AFFRONTER !"
		bullets = [
			{
				text = "Réussis chaque série de BATTLE GEMS pour obtenir des ATTAQUES."
			}
			{
				text = "Quand tu obtiens une ATTAQUE, lève le manche de ta guitare pour attaquer Joe et le déconcentrer."
			}
			{
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Quand tu obtiens une ATTAQUE, lève le manche de ta guitare pour attaquer ton adversaire et le déconcentrer."
			}
			{
...
script create_battle_helper_menu \{device_num = 0
	...
	if ($gbh_first_time_in = 0)
		...
		add_user_control_helper \{text = "CHOC DE GUITARES"
			button = green
			z = 100}
