...
script create_attract_mode_text 
	CreateScreenElement \{type = ContainerElement
		...
		id = am_container
		pos = (0.0, 0.0)}
	text = "APPUIE SUR N'IMPORTE QUELLE TOUCHE POUR COMMENCER..."
...
script check_for_any_input \{button1 = {
	...
	if NOT IsWinPort
		if IsStandardGuitarControllerPluggedIn
			if English
				notify_box scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "Une guitare non compatible a été détectée." line2 = "Connecter une manette guitare Guitar Hero ou" line3 = "une manette Xbox 360 et appuyer sur la touche START pour continuer." menu_z = 510000 FormatText TextName = pakname '%s_text.pak' s = <stem>
			elseif French
				notify_box \{scale1 = (0.6, 0.75)
					scale2 = (0.5, 0.6)
