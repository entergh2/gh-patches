...
options_calibrate_lag_dialog_1_fs = {
	...
	create_params = {
		title_text = "TEST AUDIO"
		body_text = "On va commencer par un simple calibrage audio. Appuie sur le médiator au rythme des clics. Essaie de faire cliquer ton médiator au même moment que le clic audio."
		dialog_1
	}
...
options_calibrate_lag_dialog_2_fs = {
	create = create_calibrate_lag_dialog_menu
	create_params = {
		title_text = "TEST VIDÉO"
		body_text = "Il s'agit maintenant de faire un test de calibrage vidéo. Essaie d'appuyer sur le médiator lorsque le cercle entoure parfaitement la cible."
		dialog_2
	}
	destroy = destroy_calibrate_lag_dialog_menu
	actions = [
