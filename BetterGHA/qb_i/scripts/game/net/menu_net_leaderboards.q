...
script new_leaderboard_menu 
	...
	if NOT ((<my_data> [0]) = "nessuna classificazione")
		FormatText TextName = rank "Posizione in classifica: %d" d = (<my_data> [0])
	else
		rank = (<my_data> [0])
	endif
	CreateScreenElement {
