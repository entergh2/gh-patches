...
battle_explanation_text = {
	bossjoe = {
		...
		title = "JOE PERRY VUOLE COMBATTERE!"
		bullets = [
			{
				text = "Suona tutte le serie di gemme per ottenere gli attacchi"
			}
			{
				text = "Una volta ottenuto un ATTACCO, metti la chitarra in posizione verticale per attaccare Joe e fargli mancare una nota"
			}
			{
	...
	generic = {
		...
		bullets = [
			...
			{
				text = "Una volta ottenuto un ATTACCO, metti la chitarra in posizione verticale per attaccare il tuo avversario e fargli mancare una nota"
			}
			{
				text = "DEVI BATTERLO prima della fine della partita o andrai all'ELIMINATORIA"
			}
			{
				text = "In ELIMINATORIA tutti gli ATTACCHI diventano devastanti ATTACCHI MORTALI"
			}
		]
		prompt = "Pronto per un po' di rock?"
	}
