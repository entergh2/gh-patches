...
options_calibrate_lag_dialog_1_fs = {
	...
	create_params = {
		...
		body_text = "Per prima cosa effettueremo una calibrazione dell'audio. Dai una pennata seguendo il ritmo. Cerca di produrre un clic con la barra della pennata nello stesso momento in cui senti il clic audio."
		dialog_1
	}
...
options_calibrate_lag_dialog_2_fs = {
	...
	create_params = {
		...
		body_text = "Ora effettueremo una calibrazione video. Dai una pennata quando i cerchi si allineano perfettamente con il bersaglio."
		dialog_2
	}
	destroy = destroy_calibrate_lag_dialog_menu
	actions = [
