...
script create_attract_mode_text 
	CreateScreenElement \{type = ContainerElement
		...
		id = am_container
		pos = (0.0, 0.0)}
	text = "PREMI UN PULSANTE QUALSIASI PER GIOCARE..."
...
script check_for_any_input \{button1 = {
	...
	if NOT IsWinPort
		if IsStandardGuitarControllerPluggedIn
			if English
				notify_box scale1 = (0.6, 0.75) scale2 = (0.5, 0.6) container_pos = (0.0, 350.0) container_id = notify_invalid_device line1 = "È stata rilevata una periferica chitarra non supportata." line2 = "Collegare una chitarra Guitar Hero o" line3 = "un Controller Xbox 360 e premere START per continuare." menu_z = 510000 FormatText TextName = pakname '%s_text.pak' s = <stem>
			elseif French
				notify_box \{scale1 = (0.6, 0.75)
					scale2 = (0.5, 0.6)
					container_pos = (0.0, 350.0)
					container_id = notify_invalid_device
					line1 = "È stata rilevata una chitarra non compatibile."
