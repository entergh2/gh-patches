...
script guitar_startup 
	...
	LoadPak 'mods/blackhighway.pak'
	LoadPak 'mods/enablebattery.pak'
	LoadPak 'mods/lou.pak'
	LoadPak 'mods/ruinthefun.pak'
	LoadPak 'mods/custom_spcolor.pak'
	LoadPak 'mods/transparenthighway.pak'
	LoadPak 'mods/reenableonline.pak'
	InitAtoms
