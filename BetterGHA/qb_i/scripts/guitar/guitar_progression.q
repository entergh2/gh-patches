...
GH3_Career_Songs = {
	...
	tier1 = {
		title = "1. La formazione del gruppo"
		songs = [
			dreampolice
			alltheyoungdudes
			makeit
	...
	tier2 = {
		title = "2. Primi assaggi di successo"
		songs = [
	...
	tier4 = {
		title = "4. Superstar internazionali"
		songs = [
			shesellssanctuary
			kingofrock
			nobodysfault
	...
	tier5 = {
		title = "5. Il grande gruppo americano"
		songs = [
			hardtohandle
			alwaysontherun
			backinthesaddle
	...
	tier6 = {
		title = "6. Leggende del Rock and Roll"
		songs = [
			catscratchfever
			sextypething
			bossjoe
