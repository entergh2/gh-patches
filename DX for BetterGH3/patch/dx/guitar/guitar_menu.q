...
script create_main_menu_backdrop 
	...
	main_menu_font = fontgrid_title_gh3
	version = "VERSION TAG GOES HERE"
	GetPlatform
	; set version based on return value from GetPlatform
	switch (<Platform>)
		case PS3
			FormatText TextName = version "%v%p" V = e83ec81-bettergh3 P = "-ps3"
			version_pos = (160.0, 600.0)
			version_shadow_offs = (3.0, 3.0)
			version_scale = (0.5, 0.5)
		case XENON
		 	FormatText TextName = version "%v%p" V = e83ec81-bettergh3 P = "-xbox"
		 	version_pos = (160.0, 600.0)
		 	version_shadow_offs = (3.0, 3.0)
		 	version_scale = (0.5, 0.5)
		case NGC
			FormatText TextName = version "%v%p" V = e83ec81-bettergh3 P = "-wii"
			version_pos = (130.0, 600.0)
			version_shadow_offs = (1.5, 1.5)
			version_scale = (0.7, 0.7)
		case PS2
			FormatText TextName = version "%v%p" V = e83ec81-bettergh3 P = "-ps2"
			version_pos = (130.0, 600.0)
			version_shadow_offs = (1.5, 1.5)
			version_scale = (0.7, 0.7)
	endswitch
	...
	if IsWinPort
		0xce6c989e
		FormatText TextName = version "VERSION %s (%v%p)" S = <0x112c650d> V = e83ec81-bettergh3 P = "-pc"
		version_pos = (160.0, 600.0)
		version_shadow_offs = (3.0, 3.0)
		version_scale = (0.5, 0.5)
	elseif IsMacPort
		0xce6c989e
		FormatText TextName = version "VERSION %s (%v%p)" S = <0x112c650d> V = e83ec81-bettergh3 P = "-mac"
		version_pos = (160.0, 600.0)
		version_shadow_offs = (3.0, 3.0)
		version_scale = (0.5, 0.5)
	endif
